...
public interface StudentRepository extends JpaRepository<Student, StudentPK> {
    ...
    Page<Student> findByLectureAndAcceptedAtNotNull(Lecture lecture, Pageable pageable);

    Page<Student> findByLectureAndAcceptedAtIsNull(Lecture lecture, Pageable pageable);
